        ...
        <div class="section ">
            ...
            @if(auth()->user()->role=="user")
                <form method="post" action="{{ url('user/aforadores') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="cantsurtidores" id="cantsurtidores" value="0">
                            ...
                            @foreach($turnoDetails as $key => $Detail )
                                <tr>
                                    ...
                                    <td class="text-center" >
                                        <input type="number" value="{{$Detail->surtidor->product->price}}" name="price[]" id="price_{{$key+1}}" readonly style="width: 80px;"/>
                                    </td>
                                    <!-- Lectura Inicial -->
                                    <td class="text-center">
...
<script>
    function calculaTotales(){
        ...
        $('#totalimporte').text('Total Importe: ' + vImporteTotal);    
